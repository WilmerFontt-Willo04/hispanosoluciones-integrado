                        ...
                        <div className="card-header border-0 pt-5">
                          ...
                          <div className="card-toolbar">
                            <ul className="nav">
                              ...
                              <li className="nav-item">
                                <a
                                  className="nav-link btn btn-sm btn-color-muted btn-active btn-active-dark fw-bolder px-4 me-1"
                                  data-bs-toggle="tab"
                              ...
                              <li className="nav-item">
                                <a
                                  className="nav-link btn btn-sm btn-color-muted btn-active btn-active-dark fw-bolder px-4"
                                  data-bs-toggle="tab"
            ...
            <div className="footer py-4 d-flex flex-lg-column" id="kt_footer">
              ...
              <div className="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <div className="text-dark order-2 order-md-1">
                  ...
                  <a
                    href="https://hispanossoluciones.com/"
                    target="_blank"
                        ...
                        <div className="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                          ...
                          <div className="mb-3 mb-md-0 fw-bold">
                            ...
                            <div className="fs-6 text-gray-700 pe-7">
                              Login into Metronic Admin Dashboard to make sure
